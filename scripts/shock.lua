...
local function calc_arterial_blood_ph_1(dv_, num) return num < 7.30 end
...
local dv_red_blood_cell_transfusion = { "Volume (mL)-Transfuse Red Blood Cells (mL)", "Volume (mL)-Transfuse Red Blood Cells, Irradiated (mL)" }
...
local function calc_troponin_t_1(dv_, num) return num > 59 end
...
--------------------------------------------------------------------------------
local function oxygen_check(dv, num_)
    return dv and dv.result and (string.find(dv.result, "Room Air") or string.find(dv.result, "RA"))
end
